...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       /* LinkList Lista = new LinkList();
        ...
        List_Doble_Circular Lista_DC = new List_Doble_Circular();

        Lista_DC.insertar(new Persona(1, "P"));
        Lista_DC.insertar(new Persona(3, "P"));
        Lista_DC.insertar(new Persona(2, "P"));
